...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_21839 = 0;while(true){
var m_21840 = cljs.core.async.impl.dispatch.tasks.pop();if((m_21840 == null))
{} else
{m_21840.call(null);
if((count_21839 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__21841 = (count_21839 + 1);
count_21839 = G__21841;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__9408__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__9408__auto__)
