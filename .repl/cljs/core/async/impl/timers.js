...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__9987__auto__,writer__9988__auto__,opt__9989__auto__){return cljs.core._write.call(null,writer__9988__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_21746 = 0;while(true){
if((i_21746 < arr.length))
{(arr[i_21746] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__9987__auto__,writer__9988__auto__,opt__9989__auto__){return cljs.core._write.call(null,writer__9988__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_21753 = (self__.level + 1);while(true){
if((i_21753 <= (new_level + 1)))
{(update[i_21753] = self__.header);
{
var G__21754 = (i_21753 + 1);
i_21753 = G__21754;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_21755 = 0;while(true){
if((i_21755 <= self__.level))
{var links_21756 = (update[i_21755]).forward;if(((links_21756[i_21755]) === x__$1))
{(links_21756[i_21755] = (x__$1.forward[i_21755]));
{
var G__21757 = (i_21755 + 1);
i_21755 = G__21757;
continue;
}
} else
{{
var G__21758 = (i_21755 + 1);
i_21755 = G__21758;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__9420__auto__ = (cljs.core.truth_((function (){var and__9408__auto__ = me;if(cljs.core.truth_(and__9408__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__9408__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__9420__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__9420__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__9420__auto__,timeout__$1,me))
,msecs);
