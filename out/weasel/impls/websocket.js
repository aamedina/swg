...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj12035 = {};return obj12035;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__9408__auto__ = this$;if(and__9408__auto__)
...
{var x__10047__auto__ = (((this$ == null))?null:this$);return (function (){var or__9420__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__10047__auto__)]);if(or__9420__auto__)
{return or__9420__auto__;
} else
{var or__9420__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__9420__auto____$1)
...
return (function (p__12036){var vec__12037 = p__12036;var k = cljs.core.nth.call(null,vec__12037,0,null);var v = cljs.core.nth.call(null,vec__12037,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
