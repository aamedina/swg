...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj10863 = {};return obj10863;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__9408__auto__ = this$;if(and__9408__auto__)
...
{var x__10047__auto__ = (((this$ == null))?null:this$);return (function (){var or__9420__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__10047__auto__)]);if(or__9420__auto__)
{return or__9420__auto__;
} else
{var or__9420__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__9420__auto____$1)
...
return (function (p__10864){var vec__10865 = p__10864;var k = cljs.core.nth.call(null,vec__10865,0,null);var v = cljs.core.nth.call(null,vec__10865,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10866){var vec__10867 = p__10866;var k = cljs.core.nth.call(null,vec__10867,0,null);var v = cljs.core.nth.call(null,vec__10867,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
