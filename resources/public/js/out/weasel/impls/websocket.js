...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj598086 = {};return obj598086;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__7594__auto__ = this$;if(and__7594__auto__)
...
{var x__8233__auto__ = (((this$ == null))?null:this$);return (function (){var or__7606__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__8233__auto__)]);if(or__7606__auto__)
{return or__7606__auto__;
} else
{var or__7606__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__7606__auto____$1)
...
return (function (p__598087){var vec__598088 = p__598087;var k = cljs.core.nth.call(null,vec__598088,(0),null);var v = cljs.core.nth.call(null,vec__598088,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
