...
sablono.util.ToString = (function (){var obj596706 = {};return obj596706;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__7594__auto__ = x;if(and__7594__auto__)
...
{var x__8233__auto__ = (((x == null))?null:x);return (function (){var or__7606__auto__ = (sablono.util.to_str[goog.typeOf(x__8233__auto__)]);if(or__7606__auto__)
{return or__7606__auto__;
} else
{var or__7606__auto____$1 = (sablono.util.to_str["_"]);if(or__7606__auto____$1)
...
sablono.util.ToURI = (function (){var obj596708 = {};return obj596708;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__7594__auto__ = x;if(and__7594__auto__)
...
{var x__8233__auto__ = (((x == null))?null:x);return (function (){var or__7606__auto__ = (sablono.util.to_uri[goog.typeOf(x__8233__auto__)]);if(or__7606__auto__)
{return or__7606__auto__;
} else
{var or__7606__auto____$1 = (sablono.util.to_uri["_"]);if(or__7606__auto____$1)
{return or__7606__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__596709){
var xs = cljs.core.seq(arglist__596709);
...
{var vec__596711 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__596711,(0),null);var words = cljs.core.nthnext.call(null,vec__596711,(1));if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
*/
sablono.util.html_to_dom_attrs = (function html_to_dom_attrs(attrs){var dom_attrs = cljs.core.merge.call(null,cljs.core.zipmap.call(null,cljs.core.keys.call(null,attrs),cljs.core.map.call(null,sablono.util.camel_case,cljs.core.keys.call(null,attrs))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.Keyword(null,"className","className",-1983287057),new cljs.core.Keyword(null,"for","for",-1323786319),new cljs.core.Keyword(null,"htmlFor","htmlFor",-1050291720)], null));return clojure.set.rename_keys.call(null,attrs,dom_attrs);
});
/**
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__596712_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__596712_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__596712_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__596712_SHARP_))
{return p1__596712_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__596713){
var maps = cljs.core.seq(arglist__596713);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq.call(null,/[#.]?[^#.]+/,cljs.core.name.call(null,s));var vec__596717 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):((new cljs.core.Keyword(null,"default","default",-1987822328))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null):null)));var tag_name = cljs.core.nth.call(null,vec__596717,(0),null);var names = cljs.core.nth.call(null,vec__596717,(1),null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__596717,tag_name,names){
return (function (p1__596714_SHARP_){return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__596714_SHARP_));
});})(matches,vec__596717,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__596717,tag_name,names){
return (function (p1__596715_SHARP_){return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__596715_SHARP_));
});})(matches,vec__596717,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__596718){var vec__596721 = p__596718;var tag = cljs.core.nth.call(null,vec__596721,(0),null);var content = cljs.core.nthnext.call(null,vec__596721,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__596722 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__596722,(0),null);var id = cljs.core.nth.call(null,vec__596722,(1),null);var class$ = cljs.core.nth.call(null,vec__596722,(2),null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__7606__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__7606__auto__))
{return or__7606__auto__;
} else
