...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj597949 = {};return obj597949;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7594__auto__ = this$;if(and__7594__auto__)
...
{var x__8233__auto__ = (((this$ == null))?null:this$);return (function (){var or__7606__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8233__auto__)]);if(or__7606__auto__)
{return or__7606__auto__;
} else
{var or__7606__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7606__auto____$1)
...
return (function (p__597950){var vec__597951 = p__597950;var k = cljs.core.nth.call(null,vec__597951,(0),null);var v = cljs.core.nth.call(null,vec__597951,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__597952){var vec__597953 = p__597952;var k = cljs.core.nth.call(null,vec__597953,(0),null);var v = cljs.core.nth.call(null,vec__597953,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
