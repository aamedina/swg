...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t596567 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t596567 = (function (val,box,meta596568){
this.val = val;
this.box = box;
this.meta596568 = meta596568;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t596567.cljs$lang$type = true;
cljs.core.async.impl.channels.t596567.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t596567";
cljs.core.async.impl.channels.t596567.cljs$lang$ctorPrWriter = (function (this__8173__auto__,writer__8174__auto__,opt__8175__auto__){return cljs.core._write.call(null,writer__8174__auto__,"cljs.core.async.impl.channels/t596567");
});
cljs.core.async.impl.channels.t596567.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t596567.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_596569){var self__ = this;
var _596569__$1 = this;return self__.meta596568;
});
cljs.core.async.impl.channels.t596567.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_596569,meta596568__$1){var self__ = this;
var _596569__$1 = this;return (new cljs.core.async.impl.channels.t596567(self__.val,self__.box,meta596568__$1));
});
cljs.core.async.impl.channels.__GT_t596567 = (function __GT_t596567(val__$1,box__$1,meta596568){return (new cljs.core.async.impl.channels.t596567(val__$1,box__$1,meta596568));
});
}
return (new cljs.core.async.impl.channels.t596567(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8176__auto__,writer__8177__auto__,opts__8178__auto__){return cljs.core._write.call(null,writer__8177__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8173__auto__,writer__8174__auto__,opt__8175__auto__){return cljs.core._write.call(null,writer__8174__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_596570 = self__.takes.pop();if((taker_596570 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_596570))
{var take_cb_596571 = cljs.core.async.impl.protocols.commit.call(null,taker_596570);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_596571,taker_596570,this$__$1){
return (function (){return take_cb_596571.call(null,null);
});})(take_cb_596571,taker_596570,this$__$1))
);
} else
{}
{
...
var putter_596572 = self__.puts.pop();if(!((putter_596572 == null)))
{var put_handler_596573 = putter_596572.handler;var val_596574 = putter_596572.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_596573))
{var put_cb_596575 = cljs.core.async.impl.protocols.commit.call(null,put_handler_596573);var __596576__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_596575,__596576__$1,put_handler_596573,val_596574,putter_596572,_,retval,this$__$1){
return (function (){return put_cb_596575.call(null,true);
});})(put_cb_596575,__596576__$1,put_handler_596573,val_596574,putter_596572,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_596574);
} else
{{
continue;
}
