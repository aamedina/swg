...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_596561 = (0);while(true){
var m_596562 = cljs.core.async.impl.dispatch.tasks.pop();if((m_596562 == null))
{} else
{m_596562.call(null);
if((count_596561 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__596563 = (count_596561 + (1));
count_596561 = G__596563;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7594__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7594__auto__)
