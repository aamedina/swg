...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8173__auto__,writer__8174__auto__,opt__8175__auto__){return cljs.core._write.call(null,writer__8174__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_596468 = (0);while(true){
if((i_596468 < arr.length))
{(arr[i_596468] = null);
{
var G__596469 = (i_596468 + (1));
i_596468 = G__596469;
continue;
}
} else
...
var G__596471 = x__$1;
var G__596472 = k;
var G__596473 = (level - (1));
var G__596474 = update;
x = G__596471;
k = G__596472;
level = G__596473;
update = G__596474;
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8173__auto__,writer__8174__auto__,opt__8175__auto__){return cljs.core._write.call(null,writer__8174__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_596475 = (self__.level + (1));while(true){
if((i_596475 <= (new_level + (1))))
{(update[i_596475] = self__.header);
{
var G__596476 = (i_596475 + (1));
i_596475 = G__596476;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_596477 = (0);while(true){
if((i_596477 <= self__.level))
{var links_596478 = (update[i_596477]).forward;if(((links_596478[i_596477]) === x__$1))
{(links_596478[i_596477] = (x__$1.forward[i_596477]));
{
var G__596479 = (i_596477 + (1));
i_596477 = G__596479;
continue;
}
} else
{{
var G__596480 = (i_596477 + (1));
i_596477 = G__596480;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7606__auto__ = (cljs.core.truth_((function (){var and__7594__auto__ = me;if(cljs.core.truth_(and__7594__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7594__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7606__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__7606__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__7606__auto__,timeout__$1,me))
,msecs);
